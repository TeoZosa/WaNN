...
if __name__ == '__main__':#for Windows since it lacks os.fork
  ...
  black_wins = 0
  white_wins = 0
  file_to_write = open(r'G:\TruncatedLogs\PythonDatasets\03052017_2randStartMovesBlack_randBestMoves_normalizedNNupdate_rankingOffset_ExpansionMCTSvsPolicy.txt','a')
  ...
  for i in range(1, num_games_to_play):
    winner_color = self_play_game(True, policy_opponent=expansion_MCTS, file_to_write=file_to_write)
