...
def LoadXAndy_1to1(path):
    X = pickle.load(open(path + r'value_net_rank_binary/NPDataSets/WBPOE/XMatrixByRankBinaryFeaturesWBPOEBiasNoZero.p', 'rb'))
    y = pickle.load(open(path + r'value_net_rank_binary/NPDataSets/WBPOE/yVectorByRankBinaryFeaturesWBPOEBiasNoZero.p', 'rb'))
    return X, y
