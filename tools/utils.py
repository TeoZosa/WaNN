...
def move_lookup(index, player_color):
    ...
    if player_color.lower() == 'White'.lower():
        transitions = ['a1-a2', 'b1-a2', 'b1-c2', 'c1-c2', 'd1-c2', 'd1-e2', 'e1-e2', 'f1-e2', 'f1-g2', 'g1-g2', 
                       ...
                       'g2-g3', 'h2-g3', 'a3-a4', 'b3-a4', 'b3-c4', 'c3-c4', 'd3-c4', 'd3-e4', 'e3-e4', 'f3-e4', 
                       'f3-g4', 'g3-g4', 'h3-g4', 'a4-a5', 'b4-a5', 'b4-c5', 'c4-c5', 'd4-c5', 'd4-e5', 'e4-e5', 
                       'f4-e5', 'f4-g5', 'g4-g5', 'h4-g5', 'a5-a6', 'b5-a6', 'b5-c6', 'c5-c6', 'd5-c6', 'd5-e6', 
                       'e5-e6', 'f5-e6', 'f5-g6', 'g5-g6', 'h5-g6', 'a6-a7', 'b6-a7', 'b6-c7', 'c6-c7', 'd6-c7', 
                       'd6-e7', 'e6-e7', 'f6-e7', 'f6-g7', 'g6-g7', 'h6-g7', 'a7-a8', 'b7-a8', 'b7-c8', 'c7-c8', 
                       'd7-c8', 'd7-e8', 'e7-e8', 'f7-e8', 'f7-g8', 'g7-g8', 'h7-g8', 'no-move']
